    ...
    <>
      ...
      <section class="dashboard">
        <div class="dashboard-left">
          ...
          <a href="">
            {" "}
            <p><img src="/dash-btn.png" atl="" /></p> <span></span>
          </a>
        </div>
        </div>
        <div class="dashboard-right">
          ...
          <div class="container-fluid">
            ...
            <div class="wallet-row1">
              <div class="walletrow1-left">
                <img src="/coin_png.gif" alt="" />
              </div>
              <div class="walletrow1-right">
                <img src="/coin_png.gif" alt="" id="star-coin" />
                <div class="wrow1-left">
                  <div class="e1-left">
                    <img style={{ width: "80%" }} src="/pp.png" alt="" />
                  </div>
                  <div class="e1-right">
                    <p>E Wallet</p>
                    <span>
                      Total Balance (in P2PBits) :<strong> </strong>
                    </span>
                  </div>
                </div>
                <div class="wrow1-right">
                  <div
                    class="modal fade"
                  ...
                  >
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content ewallet-content">
                        <div class="modal-header ewallet-header">
                          <button
                            type="button"
                            class="btn-close ewallet-close"
                            data-bs-dismiss="modal"
                            aria-label="Close"
                          ></button>
                        </div>
                        <div class="modal-body ewallet-body">
                          <p>
                            Enter the amount you wish to withdraw from your
                            available balance.
                          </p>
                        </div>
                        <div class="modal-footer ewallet-footer">
                          <button
                            class="btn btn-primary efoot-button"
                  ...
                  >
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content ewallet1-content">
                        <div class="modal-body ewallet1-body">
                          <ul>
                            <li>
                              <span>Withdraw Amount</span> <span>xx</span>{" "}
                            </li>
                            <li>
                              <span>Fees</span> <span>xx</span>{" "}
                            </li>
                            <li>
                              <span>Balance</span> <span>xx</span>{" "}
                            </li>
                          </ul>
                        </div>
                        <div class="modal-footer ewallet1-footer">
                          <button
                            class="btn btn-primary ewallet1-button"
                          ...
                          <button
                            class="btn btn-secondary ewallet1-button"
                            data-bs-target="#exampleModalToggle"
                            data-bs-toggle="modal"
                          >
                            No,Go Back
                  ...
                  <button
                    class="btn btn-primary e-request"
                    data-bs-target="#exampleModalToggle"
                    data-bs-toggle="modal"
                  >
                    Request withdraw
            ...
            <div class="wallet-row2">
              <div class="walletrow2-head">
                <div class="wrow2head-left">
                  <h4>Transaction History</h4>
                </div>
                <div class="wrow2head-right">
                ...
                <table class="table table-dark table-striped">
                  ...
                  <tbody>
                    {/* <tr>
                      <td>01</td>
                      <td>84572</td>
                      <td>10 Nov 2020 | 11:34</td>
                      <td>Withdraw</td>
                      <td>
                        <span class="e-processed">Processed</span>
                      </td>
                      <td>xx.xxx</td>
                    </tr> */}
                  </tbody>
